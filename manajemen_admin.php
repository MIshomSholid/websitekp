...
try {
    ...
    $activeProducts = $pdo->query("SELECT COUNT(*) FROM products WHERE status = 'aktif'")->fetchColumn();
    ...
    <nav class="admin-nav">
        <div class="container d-flex justify-content-between align-items-center">
            <a href="manajemen_admin.php" class="brand-title">
                <img src="logohonkong2d.png" alt="Logo" onerror="this.src='logohongkong.png'">
    ...
    <div class="container py-4">
        ...
        <div class="admin-list-card">
            ...
            <div class="admin-items-list">
                <?php
                try {
                    $adminStmt = $pdo->query("SELECT id, username FROM users ORDER BY id");
                    ...
                    echo '<p class="text-danger">Gagal memuat daftar admin.</p>';
                }
                ?>
            </div>
        </div>
