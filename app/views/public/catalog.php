...
<head>
    ...
    <meta name="description" content="<?= htmlspecialchars($categoryMetaDescription) ?>">
    ...
    <nav class="navbar navbar-expand-lg hk-navbar" id="mainNavbar">
        <div class="container">
            <a class="navbar-brand-hk" href="index.php#beranda">
                <img src="logohonkong2d.png" alt="Logo UD. Toko Hongkong" onerror="this.src='assets/images/logohongkong.png'">
                ...
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu border-0 shadow-sm">
                            <li><a class="dropdown-item <?= $currentCategory === 'atasan' ? 'fw-bold text-gold' : '' ?>" href="atasan.php"><i class="fas fa-tshirt me-2"></i>Koleksi Atasan</a></li>
                            <li><a class="dropdown-item <?= $currentCategory === 'bawahan' ? 'fw-bold text-gold' : '' ?>" href="bawahan.php"><i class="fas fa-male me-2"></i>Koleksi Bawahan</a></li>
                            <li><a class="dropdown-item <?= $currentCategory === 'dalaman' ? 'fw-bold text-gold' : '' ?>" href="dalaman.php"><i class="fas fa-heart me-2"></i>Pakaian Dalam</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item ms-lg-3 mt-3 mt-lg-0">
                        <a href="https://wa.me/6281357044752?text=Halo%20UD.%20Toko%20Hongkong,%20saya%20ingin%20tanya%20produk%20kategori%20<?= $currentCategory === 'dalaman' ? 'pakaian%20dalam' : $currentCategory ?>." target="_blank" class="btn-hk-whatsapp py-2 px-3">
            ...
            <div class="filter-card" data-aos="fade-up">
                <div class="filter-card-header">
                    ...
                    <?php if (!empty($search) || $minPrice !== null || $maxPrice !== null || !empty($gender) || !empty($size_input)): ?>
                        <a href="<?= $actionUrl ?>" class="text-danger fw-semibold fs-7 text-decoration-none">
                ...
                <form method="GET" action="<?= $actionUrl ?>" class="row g-3 align-items-end">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="search" class="form-control filter-input-control border-start-0 ps-0" placeholder="<?= htmlspecialchars($searchPlaceholder) ?>" value="<?= htmlspecialchars($search) ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6 col-6">
                        ...
                        <input type="number" name="minPrice" class="filter-input-control" placeholder="<?= $currentCategory === 'atasan' ? 'Rp Min (Contoh: 30000)' : 'Rp Min' ?>" value="<?= htmlspecialchars($minPriceInput) ?>" min="0" step="5000">
                    </div>

                    <!-- Max Price -->
                    <div class="col-lg-2 col-md-6 col-6">
                        <label class="filter-input-label">Harga Maksimum</label>
                        <input type="number" name="maxPrice" class="filter-input-control" placeholder="<?= $currentCategory === 'atasan' ? 'Rp Max (Contoh: 150000)' : 'Rp Max' ?>" value="<?= htmlspecialchars($maxPriceInput) ?>" min="0" step="5000">
                    </div>
                    ...
                    <div class="col-lg-2 col-md-12 d-flex gap-2">
                        ...
                        <a href="<?= $actionUrl ?>" class="btn-hk-outline py-2 px-3" title="Reset Filter">
            ...
            <div class="product-catalog-grid">
                <?php if (!empty($products)): ?>
                    <?php foreach ($products as $p): 
                        $thumb = UploadHelper::getThumbPath($p['image'], $defaultFallbackImage);
                    ...
                    ?>
                        <div class="product-item-card" data-aos="fade-up">
                            ...
                            <div class="product-card-details">
                                ...
                                <button type="button" class="product-btn-action" onclick="openProductModal(<?= $p['id'] ?>, '<?= addslashes(htmlspecialchars($p['name'])) ?>', '<?= $thumb ?>', '<?= $formattedPrice ?>', '<?= htmlspecialchars($productGender) ?>', '<?= htmlspecialchars($productSize) ?>', <?= $productStock ?>, '<?= addslashes(htmlspecialchars($categoryTitle)) ?>')">
                ...
                <?php else: ?>
                    ...
                    <div class="empty-catalog-state">
                        ...
                        <p>Kami tidak menemukan produk <?= htmlspecialchars(strtolower($categoryTitle)) ?> yang sesuai dengan filter pencarian Anda. Silakan coba atur ulang filter atau gunakan kata kunci lain.</p>
                        <a href="<?= $actionUrl ?>" class="btn-hk-primary">
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-md-5">
                            <div class="modal-product-thumb">
                                <img id="modalProductImg" src="<?= $defaultFallbackImage ?>" alt="Produk">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <span class="badge bg-subtle text-navy border mb-2" id="modalProductCategory"><?= htmlspecialchars($categoryTitle) ?></span>
                            ...
                            <table class="modal-spec-table">
                                <tr>
                                    <td>Kategori</td>
                                    <td id="modalSpecCategory"><?= htmlspecialchars(ucfirst($currentCategory)) ?></td>
                                </tr>
                                <tr>
                                    <td>Gender / Tipe</td>
                                ...
                                <tr>
                                    ...
                                    <td>Bahan adem, nyaman dipakai, jahitan rapi kualitas toko fisik.</td>
                                </tr>
                            </table>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <img src="logohonkong2d.png" alt="UD. Toko Hongkong" style="height: 38px;" onerror="this.src='assets/images/logohongkong.png'">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="footer-links">
                        <li><a href="atasan.php" class="<?= $currentCategory === 'atasan' ? 'text-gold fw-semibold' : '' ?>"><i class="fas fa-angle-right"></i>Koleksi Atasan (Kemeja & Kaos)</a></li>
                        <li><a href="bawahan.php" class="<?= $currentCategory === 'bawahan' ? 'text-gold fw-semibold' : '' ?>"><i class="fas fa-angle-right"></i>Koleksi Bawahan (Jeans & Rok)</a></li>
                        <li><a href="dalaman.php" class="<?= $currentCategory === 'dalaman' ? 'text-gold fw-semibold' : '' ?>"><i class="fas fa-angle-right"></i>Pakaian Dalam (Underwear)</a></li>
