<?php
// atasan.php - UD. Toko Hongkong Kapasan
require_once 'config.php';

$currentCategory = 'atasan';
$categoryTitle = 'Koleksi Atasan';
$categorySubtitle = 'Koleksi lengkap kemeja formal & casual, kaos katun polos premium, blouse wanita, dan busana atasan berkualitas terbaik dengan harga grosir & eceran.';
$defaultFallbackImage = 'kaos.png';
...
try {
    ...
    error_log("Database error in atasan: " . $e->getMessage());
    $products = [];
    $error_message = "Terjadi kendala saat memuat produk katalog.";
}

if (!function_exists('getThumbPath')) {
    function getThumbPath($imgName, $fallback = 'kaos.png') {
...
<head>
    ...
    <meta name="description" content="Katalog Koleksi Atasan UD. Toko Hongkong Kapasan Surabaya. Kemeja formal & casual, kaos polos premium, blouse wanita grosir & eceran.">
                ...
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu border-0 shadow-sm">
                            <li><a class="dropdown-item fw-bold text-gold" href="atasan.php"><i class="fas fa-tshirt me-2"></i>Koleksi Atasan</a></li>
                            <li><a class="dropdown-item" href="bawahan.php"><i class="fas fa-male me-2"></i>Koleksi Bawahan</a></li>
                            <li><a class="dropdown-item" href="dalaman.php"><i class="fas fa-heart me-2"></i>Pakaian Dalam</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item ms-lg-3 mt-3 mt-lg-0">
                        <a href="https://wa.me/6281357044752?text=Halo%20UD.%20Toko%20Hongkong,%20saya%20ingin%20tanya%20produk%20kategori%20atasan." target="_blank" class="btn-hk-whatsapp py-2 px-3">
            ...
            <div class="filter-card" data-aos="fade-up">
                <div class="filter-card-header">
                    ...
                    <?php if (!empty($search) || $minPrice !== null || $maxPrice !== null || !empty($gender) || !empty($size_input)): ?>
                        <a href="atasan.php" class="text-danger fw-semibold fs-7 text-decoration-none">
                            <i class="fas fa-times-circle me-1"></i>Hapus Semua Filter
                        </a>
                    <?php endif; ?>
                </div>

                <form method="GET" action="atasan.php" class="row g-3 align-items-end">
                    <!-- Search Input -->
                    <div class="col-lg-3 col-md-6">
                        <label class="filter-input-label">Cari Nama Produk</label>
                        <div class="input-group">
                            <span class="input-group-text bg-white border-end-0"><i class="fas fa-search text-muted"></i></span>
                            <input type="text" name="search" class="form-control filter-input-control border-start-0 ps-0" placeholder="Kemeja, Kaos, Blouse..." value="<?= htmlspecialchars($search) ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-6 col-6">
                        ...
                        <input type="number" name="minPrice" class="filter-input-control" placeholder="Rp Min (Contoh: 30000)" value="<?= htmlspecialchars($minPriceInput) ?>" min="0" step="5000">
                    </div>

                    <!-- Max Price -->
                    <div class="col-lg-2 col-md-6 col-6">
                        <label class="filter-input-label">Harga Maksimum</label>
                        <input type="number" name="maxPrice" class="filter-input-control" placeholder="Rp Max (Contoh: 150000)" value="<?= htmlspecialchars($maxPriceInput) ?>" min="0" step="5000">
                    </div>
                    ...
                    <div class="col-lg-2 col-md-12 d-flex gap-2">
                        ...
                        <a href="atasan.php" class="btn-hk-outline py-2 px-3" title="Reset Filter">
            ...
            <div class="product-catalog-grid">
                    ...
                    ?>
                        <div class="product-item-card" data-aos="fade-up">
                            ...
                            <div class="product-card-details">
                                ...
                                <button type="button" class="product-btn-action" onclick="openProductModal(<?= $p['id'] ?>, '<?= addslashes(htmlspecialchars($p['name'])) ?>', '<?= $thumb ?>', '<?= $formattedPrice ?>', '<?= htmlspecialchars($productGender) ?>', '<?= htmlspecialchars($productSize) ?>', <?= $productStock ?>, 'Koleksi Atasan')">
                ...
                <?php else: ?>
                    ...
                    <div class="empty-catalog-state">
                        ...
                        <p>Kami tidak menemukan produk atasan yang sesuai dengan filter pencarian Anda. Silakan coba atur ulang filter atau gunakan kata kunci lain.</p>
                        <a href="atasan.php" class="btn-hk-primary">
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-md-5">
                            <div class="modal-product-thumb">
                                <img id="modalProductImg" src="kaos.png" alt="Produk">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <span class="badge bg-subtle text-navy border mb-2" id="modalProductCategory">Koleksi Atasan</span>
                            ...
                            <table class="modal-spec-table">
                                <tr>
                                    <td>Kategori</td>
                                    <td id="modalSpecCategory">Atasan</td>
                                </tr>
                                <tr>
                                    <td>Gender / Tipe</td>
        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="footer-links">
                        <li><a href="atasan.php" class="text-gold fw-semibold"><i class="fas fa-angle-right"></i>Koleksi Atasan (Kemeja & Kaos)</a></li>
