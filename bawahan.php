<?php
// bawahan.php - UD. Toko Hongkong Kapasan
require_once 'config.php';

$currentCategory = 'bawahan';
$categoryTitle = 'Koleksi Bawahan';
$categorySubtitle = 'Pilihan celana jeans tangguh, celana panjang formal kerja, celana santai kasual, serta aneka rok wanita motif dan polos berkualitas tinggi dengan harga grosir & eceran.';
$defaultFallbackImage = 'suit.png';
...
try {
    ...
    error_log("Database error in bawahan: " . $e->getMessage());
    $products = [];
    $error_message = "Terjadi kendala saat memuat produk katalog.";
}

if (!function_exists('getThumbPath')) {
    function getThumbPath($imgName, $fallback = 'suit.png') {
...
<head>
    ...
    <meta name="description" content="Katalog Koleksi Bawahan UD. Toko Hongkong Kapasan Surabaya. Celana jeans, celana formal, rok wanita berkualitas grosir & eceran.">
                ...
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu border-0 shadow-sm">
                            ...
                            <li><a class="dropdown-item fw-bold text-gold" href="bawahan.php"><i class="fas fa-male me-2"></i>Koleksi Bawahan</a></li>
                    ...
                    <li class="nav-item ms-lg-3 mt-3 mt-lg-0">
                        <a href="https://wa.me/6281357044752?text=Halo%20UD.%20Toko%20Hongkong,%20saya%20ingin%20tanya%20produk%20kategori%20bawahan." target="_blank" class="btn-hk-whatsapp py-2 px-3">
            ...
            <div class="filter-card" data-aos="fade-up">
                <div class="filter-card-header">
                    ...
                    <?php if (!empty($search) || $minPrice !== null || $maxPrice !== null || !empty($gender) || !empty($size_input)): ?>
                        <a href="bawahan.php" class="text-danger fw-semibold fs-7 text-decoration-none">
                            <i class="fas fa-times-circle me-1"></i>Hapus Semua Filter
                        </a>
                    <?php endif; ?>
                </div>

                <form method="GET" action="bawahan.php" class="row g-3 align-items-end">
                    <!-- Search Input -->
                    <div class="col-lg-3 col-md-6">
                        <label class="filter-input-label">Cari Nama Produk</label>
                        <div class="input-group">
                            <span class="input-group-text bg-white border-end-0"><i class="fas fa-search text-muted"></i></span>
                            <input type="text" name="search" class="form-control filter-input-control border-start-0 ps-0" placeholder="Celana Jeans, Rok, Formal..." value="<?= htmlspecialchars($search) ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-12 d-flex gap-2">
                        ...
                        <a href="bawahan.php" class="btn-hk-outline py-2 px-3" title="Reset Filter">
            ...
            <div class="product-catalog-grid">
                    ...
                    ?>
                        <div class="product-item-card" data-aos="fade-up">
                            ...
                            <div class="product-card-details">
                                ...
                                <button type="button" class="product-btn-action" onclick="openProductModal(<?= $p['id'] ?>, '<?= addslashes(htmlspecialchars($p['name'])) ?>', '<?= $thumb ?>', '<?= $formattedPrice ?>', '<?= htmlspecialchars($productGender) ?>', '<?= htmlspecialchars($productSize) ?>', <?= $productStock ?>, 'Koleksi Bawahan')">
                ...
                <?php else: ?>
                    ...
                    <div class="empty-catalog-state">
                        ...
                        <p>Kami tidak menemukan produk bawahan yang sesuai dengan filter pencarian Anda. Silakan coba atur ulang filter atau gunakan kata kunci lain.</p>
                        <a href="bawahan.php" class="btn-hk-primary">
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-md-5">
                            <div class="modal-product-thumb">
                                <img id="modalProductImg" src="suit.png" alt="Produk">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <span class="badge bg-subtle text-navy border mb-2" id="modalProductCategory">Koleksi Bawahan</span>
                            ...
                            <table class="modal-spec-table">
                                <tr>
                                    <td>Kategori</td>
                                    <td id="modalSpecCategory">Bawahan</td>
                                </tr>
                                <tr>
                                    <td>Gender / Tipe</td>
                                ...
                                <tr>
                                    ...
                                    <td>Bahan adem, awet, jahitan rapi kualitas toko fisik Pasar Kapasan.</td>
                                </tr>
                            </table>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="bawahan.php" class="text-gold fw-semibold"><i class="fas fa-angle-right"></i>Koleksi Bawahan (Jeans & Rok)</a></li>
