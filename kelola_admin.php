    ...
    switch ($_POST['action']) {
        case 'add_admin':
            ...
            try {
                ...
                echo json_encode(['success' => false, 'message' => 'Gagal menambahkan admin: ' . $e->getMessage()]);
            }
            break;
        ...
        case 'edit_admin':
            ...
            if ($stmt->fetch()) {
                echo json_encode(['success' => false, 'message' => 'Username sudah digunakan oleh admin lain!']);
                exit;
            }
            ...
            try {
                ...
                echo json_encode(['success' => false, 'message' => 'Gagal mengupdate admin: ' . $e->getMessage()]);
            }
            break;
        ...
        case 'delete_admin':
            ...
            if ($id == $_SESSION['user_id']) {
                echo json_encode(['success' => false, 'message' => 'Tidak dapat menghapus akun Anda sendiri yang sedang aktif!']);
                exit;
            }
            ...
            try {
                ...
                echo json_encode(['success' => false, 'message' => 'Gagal menghapus admin: ' . $e->getMessage()]);
            }
            break;
